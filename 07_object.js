...
//   console.log(student.familyMemberNames);console.log(`Object entries`);
...
console.log(`=================================for in loop=======================================`);
  ...
  let isAvailable="age" in billgates;
  console.log(isAvailable);
  if (isAvailable) {
    delete billgates.age;
    console.log(`age property is deleted`);
  }
